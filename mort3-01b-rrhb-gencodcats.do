...
//circulatory subcategories
gen cardiac          = cond(codcat==7 & circsubcat==1, 1, 0)
gen cerebrovascular  = cond(codcat==7 & circsubcat==2, 1, 0)
gen othercirculatory = cond(codcat==7 & circsubcat==3, 1, 0)

//sanity check
tab circulation cardiac, miss
tab circulation cerebrovascular, miss
tab circulation othercirculatory, miss
